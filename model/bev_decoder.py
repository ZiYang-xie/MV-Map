...
class SimpleDecoder(nn.Module):
    def __init__(self, 
        ...
        self.up1 = Up_block(64 + 256, 256, scale_factor=4)
...
class BevDecoder(nn.Module):
    def __init__(self, decoder_cfg):
        ...
        if self.cfg.type == 'Simple':
            self.bev_decoder = SimpleDecoder(in_channel=self.cfg.in_channel, out_channel=self.cfg.out_channel)
        elif self.cfg.type == 'UNet':
            self.bev_decoder = UNet(in_channel=self.cfg.in_channel, out_channel=self.cfg.out_channel)
        else:
            raise NotImplementedError

    def forward(self, x):
        return self.bev_decoder(x)